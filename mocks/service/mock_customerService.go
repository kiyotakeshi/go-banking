...
func (m *MockCustomerService) GetAllCustomer(status string) ([]dto.CustomerResponse, *errs.ApplicationError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCustomer", status)
...
func (mr *MockCustomerServiceMockRecorder) GetAllCustomer(status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCustomer", reflect.TypeOf((*MockCustomerService)(nil).GetAllCustomer), status)
}

// GetCustomer mocks base method.
func (m *MockCustomerService) GetCustomer(arg0 string) (*dto.CustomerResponse, *errs.ApplicationError) {
	m.ctrl.T.Helper()
